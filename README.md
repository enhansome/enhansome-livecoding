...
# Awesome All things live coding with stars
...
* [Alda](https://github.com/alda-lang/alda) ⭐ 5,936 | 🐛 7 | 🌐 Go | 📅 2026-08-19 - A music programming language for musicians.

  `Windows | macOS | GNU/Linux` `FLOSS` `audio`

* [ORCΛ](https://github.com/hundredrabbits/Orca) ⭐ 5,073 | 🐛 39 | 🌐 JavaScript | 📅 2025-11-16 - An esoteric live coding environment with two-dimensional syntax.

  `Windows | macOS | GNU/Linux` `audio` `FLOSS`

* [hydra](https://github.com/hydra-synth/hydra) ⭐ 2,699 | 🐛 98 | 🌐 JavaScript | 📅 2026-04-25 - Live Coding networked visuals in the browser.
...
* [WASM-music](https://github.com/petersalomonsen/javascriptmusic/blob/master/wasmaudioworklet/README.md) ⭐ 427 | 🐛 5 | 🌐 JavaScript | 📅 2026-08-22 - A live-coding environment for performance, composition and synthesis in the web-browser.

  `Google Chrome | Mozilla Firefox` `web` `JavaScript` `MIDI` `audio` `WebAudio`

* [mutate4l](https://github.com/carrierdown/mutate4l) ⭐ 419 | 🐛 12 | 🌐 C# | 📅 2023-12-07 - Live coding integrated into Ableton Live's session view.

  `Windows | macOS` `Max for Live` `C#` `FLOSS` `audio`

* [Mercury](https://github.com/tmhglnd/mercury) ⭐ 376 | 🐛 36 | 🌐 Max | 📅 2026-08-23 | [Mercury Playground](https://mercury.timohoogland.com) - A highly abstracted minimal language for the live coding of algorithmic music, designed to make code more accessible for both the performer and the audience. Runs in Max or the Browser.

  `Windows | macOS` `Chrome | Firefox` `audio` `visuals` `MaxMSP` `JavaScript`

* [Sardine](https://github.com/Bubobubobubobubo/Sardine) ⭐ 324 | 🐛 19 | 🌐 Python | 📅 2025-05-19 A Python based live coding library (MIDI/OSC/SuperDirt).

  `Windows | macOS | GNU/Linux` `Python` `SuperCollider` `FLOSS` `audio` `midi` `Open Sound Control`

* [Skoar](https://github.com/sofakid/Skoarcery) ⭐ 301 | 🐛 16 | 🌐 SuperCollider | 📅 2015-12-14 - A high-level language for coding music with SuperCollider. (inactive)

  `Windows | macOS | GNU/Linux` `SuperCollider` `Python` `FLOSS` `audio`

* [sema](https://github.com/mimic-sussex/sema) ⭐ 164 | 🐛 99 | 🌐 Svelte | 📅 2025-01-27 - Sema – A Playground for Live Coding Music and Machine Learning. (inactive)

  `Windows | macOS | GNU/Linux` `JavaScript` `FLOSS` `audio`

* [line](https://github.com/pd3v/line) ⭐ 152 | 🐛 0 | 🌐 C++ | 📅 2025-08-11 - A tiny command-line midi sequencer and language for live coding.

  `Windows | macOS | GNU/Linux` `c++` `FLOSS` `midi` `audio`

* [Facet](https://github.com/mjcella/facet) ⭐ 112 | 🐛 2 | 📅 2026-06-19 - An open source livecoding environment in NodeJS with a text editor in the browser.
...
* [Punctual](https://github.com/dktr0/Punctual) ⭐ 101 | 🐛 3 | 🌐 JavaScript | 📅 2026-05-21 - Browser-based, zero-installation, audiovisual live coding language (available in Estuary and as a standalone).

  `Google Chrome | Mozilla Firefox` `web` `WebGL` `JavaScript` `FLOSS` `visuals`

* [ixi lang](https://github.com/thormagnusson/ixilang) ⭐ 93 | 🐛 4 | 🌐 SuperCollider | 📅 2015-03-05 - An experimental project concerned with the creation of digital musical instruments and environments for generative music. (inactive)

  `Windows | macOS | GNU/Linux` `FLOSS` `SuperCollider` `audio`

* [Negasonic](https://github.com/merongivian/negasonic) ⭐ 89 | 🐛 2 | 🌐 Ruby | 📅 2025-08-11 - Live coding in the browser with Ruby.

  `Google Chrome | Mozilla Firefox` `web` `Ruby` `FLOSS` `audio`

* [Moonlet](https://github.com/elihugarret/Moonlet) ⭐ 77 | 🐛 3 | 🌐 Lua | 📅 2019-02-22 - Lua live coding. (inactive)

  `Windows | GNU/Linux` `FLOSS` `audio`

* [Mégra.rs](https://github.com/the-drunk-coder/megra.rs) ⚠️ Archived - A high-level, LISP-y live coding language implemented in Rust. Prominently features Markov chains.

  `Windows | macOS | GNU/Linux` `FLOSS` `audio` `LISP` `rust`

* [Steno](https://github.com/musikinformatik/Steno) ⭐ 73 | 🐛 8 | 🌐 SuperCollider | 📅 2024-10-25 - Concatenative little metalanguage for live coding.

  ` macOS | GNU/Linux` `SuperCollider` `FLOSS` `audio`

* [Limut](https://github.com/sdclibbery/limut) ⭐ 70 | 🐛 3 | 🌐 JavaScript | 📅 2026-08-25 - Live code music and visuals in a web browser.

  `Google Chrome | Mozilla Firefox | Safari` `web` `JavaScript` `FLOSS` `audio` `visuals`

* [TimeLines](https://github.com/lnfiniteMonkeys/TimeLines-hs) ⭐ 62 | 🐛 5 | 🌐 Haskell | 📅 2026-06-14 - A modular synthesizer for live coding the flow of time. (inactive)

  `Windows | macOS | GNU/Linux` `FLOSS` `Haskell` `SuperCollider` `audio`

* [Bacalao](https://github.com/totalgee/bacalao) ⭐ 48 | 🐛 1 | 🌐 SuperCollider | 📅 2025-05-26 - A live-coding library for SuperCollider inspired by Tidalcycles syntax.

  `Windows | macOS | GNU/Linux` `SuperCollider` `audio`

* [re\<urse](https://github.com/carrierdown/recurse) ⭐ 46 | 🐛 3 | 🌐 TypeScript | 📅 2017-08-02 - A language for generating musical patterns. (inactive)

  `abandoned` `Windows | macOS | GNU/Linux` `TypeScript` `FLOSS` `audio`

* [Krill](https://github.com/Mdashdotdashn/krill) ⭐ 43 | 🐛 0 | 🌐 JavaScript | 📅 2026-08-16 - Tidal cycle like live coding in NodeJS / Browser. (inactive)

  `Windows | macOS | GNU/Linux` `NodeJS` `Browser` `FLOSS` `midi`

* [tinyspec](https://github.com/nwoeanhinnogaehr/tinyspec-cling) ⭐ 41 | 🐛 3 | 🌐 C++ | 📅 2022-06-07 - A C++ live-coding environment for overlap-add (re)synthesis. (inactive)

  `GNU/Linux` `C++` `FLOSS` `audio`

* [Wulfcode](https://github.com/echolevel/wulfcode) ⭐ 32 | 🐛 4 | 🌐 Java | 📅 2016-05-13 - A Midi live-coding environment for performance or composition. (inactive)

  `macOS | Windows* | GNU/Linux*` `FLOSS` `audio`

* [Coypu](https://github.com/lucretiomsp/Coypu) ⭐ 28 | 🐛 9 | 🌐 Smalltalk | 📅 2026-07-05 - A Pharo Smalltalk package for programming music on-the-fly with support for multiple audio servers

  `Windows | macOS | GNU/Linux` `Pharo`  `midi` `Open Sound Control` `FLOSS` `audio`

* [LocoMotion](https://github.com/dktr0/LocoMotion) ⭐ 25 | 🐛 0 | 🌐 PureScript | 📅 2026-07-20 - A browser-based language for live coding dance, choreography, and 3D visuals (available in Estuary and as a standalone).

  `Google Chrome | Mozilla Firefox` `web` `WebGL` `JavaScript` `FLOSS` `visuals`

* [zeroone](https://github.com/pd3v/zeroone) ⭐ 22 | 🐛 0 | 🌐 C++ | 📅 2023-08-18 - Multi-instrumental, polyphonic, "DSLish" API for live coding music in C++.

  `macOS | Windows | GNU/Linux` `FLOSS` `audio`

* [Repetition.sc](https://github.com/lvm/Repetition.sc) ⭐ 16 | 🐛 0 | 🌐 SuperCollider | 📅 2018-12-14 - A set of tools to build a SequenceableCollection of Events. (inactive)

  `Windows | macOS | GNU/Linux` `SuperCollider` `FLOSS` `audio`

* [serialist](https://github.com/irritant/serialist) ⭐ 16 | 🐛 0 | 🌐 JavaScript | 📅 2016-11-26 - A live coding environment that generates MIDI messages. (inactive)

  `Windows | macOS | GNU/Linux` `JavaScript` `FLOSS` `audio`

* [Tinalla](https://github.com/axelkramble/tinalla/) ⭐ 10 | 🐛 5 | 🌐 JavaScript | 📅 2022-12-11 - Framework Regex based for language parsing written in javascript. (inactive)

  `Windows | macOS | GNU/Linux` `FLOSS` `Javascript` `SuperCollider` `audio`

* [synth-x](https://github.com/luiscript/synth-x) ⭐ 9 | 🐛 0 | 🌐 JavaScript | 📅 2017-04-11 - An experimental live coding environment for making music created with modern web technologies. (inactive)
...
* [glslViewer](https://github.com/patriciogonzalezvivo/glslViewer) ⭐ 5,322 | 🐛 70 | 🌐 C++ | 📅 2026-08-19 - Live GLSL coding render for macOS and Linux.
...
* [Ronin](https://github.com/hundredrabbits/Ronin) ⭐ 1,229 | 🐛 15 | 🌐 HTML | 📅 2025-04-16 - LISP repl for graphics livecoding.
...
* [HYLOGEN](https://github.com/sleexyz/hylogen) ⭐ 488 | 🐛 20 | 🌐 JavaScript | 📅 2024-01-15 - An embedding of GLSL in Haskell.
* [strudel.nvim](https://github.com/gruvw/strudel.nvim) ⭐ 479 | 🐛 4 | 🌐 JavaScript | 📅 2026-04-10 - A Neovim based Strudel controller.
* [jet-live](https://github.com/ddovod/jet-live) ⭐ 456 | 🐛 14 | 🌐 C++ | 📅 2026-03-02 - A library which implements c++ hot code reload approach for Linux and macOS.
...
* [Supriya](https://github.com/josiah-wolf-oberholtzer/supriya) ⭐ 405 | 🐛 17 | 🌐 Python | 📅 2026-08-25 - A Python API for SuperCollider.
...
* [cl-collider](https://github.com/byulparan/cl-collider) ⭐ 263 | 🐛 1 | 🌐 Common Lisp | 📅 2026-08-23 - A SuperCollider client for CommonLisp.
...
* [LiCK](https://github.com/heuermh/lick) ⭐ 160 | 🐛 17 | 🌐 ChucK | 📅 2026-02-05 - Library for ChucK, provides intervals, chords, scales, arpeggiators, patterns, effects, etc.
* [WavTexture](https://github.com/keijiro/WavTexture) ⭐ 114 | 🐛 0 | 🌐 C# | 📅 2017-01-26 - A Unity example showing how to bake a waveform of an audio clip into a texture and use it in a shader.
* [Petal](https://github.com/siaflab/petal) ⭐ 96 | 🐛 0 | 🌐 Ruby | 📅 2022-04-24 - A small language on Sonic Pi with similar syntax to TidalCycles.
* [Live Coding Toolkit](https://github.com/algomusic/Live-Coding-Toolkit-for-Pure-Data) ⭐ 95 | 🐛 0 | 📅 2025-12-13 - A suite of Pure Data abstractions (predefined functions) for musical live coding.
* [disclojure](https://github.com/pjagielski/disclojure) ⭐ 89 | 🐛 0 | 🌐 Clojure | 📅 2019-02-11 - A live coding environment for Overtone and Leipzig.
* [Extramuros](https://github.com/d0kt0r0/extramuros) ⭐ 78 | 🐛 0 | 🌐 JavaScript | 📅 2020-06-17 - Language-neutral shared-buffer networked live coding system.
* [Lua2SC](https://github.com/sonoro1234/Lua2SC) ⭐ 70 | 🐛 2 | 🌐 Lua | 📅 2025-11-14 - Lua client for superCollider scsynth and supernova.
* [LiveCore](https://github.com/freeeco/livecore) ⭐ 57 | 🐛 0 | 📅 2019-09-21 - Library for live coding inside Reaktor Core.
* [pytebeat](https://github.com/kragen/pytebeat) ⭐ 57 | 🐛 1 | 🌐 Python | 📅 2017-11-09 - A piece of software for doing livecoding [bytebeat](http://canonical.org/%7Ekragen/bytebeat/) performances.
* [EspGrid](https://github.com/d0kt0r0/EspGrid) ⭐ 47 | 🐛 0 | 🌐 Objective-C | 📅 2020-06-17 - Synchronization and sharing for network music.
* [TidalUnity](https://github.com/moxuse/tidal-unity) ⭐ 46 | 🐛 3 | 🌐 C# | 📅 2019-01-27 - An interface between TidalCycles and Unity 3D.
* [ANSIedad](https://github.com/gabochi/ANSIedad) ⭐ 45 | 🐛 0 | 🌐 Python | 📅 2020-07-08 - Generate visuals through a terminal emulator using ANSI escape codes.
* [Tidal-Unity](https://github.com/lvm/Tidal-Unity) ⭐ 44 | 🐛 0 | 🌐 C# | 📅 2018-03-21 - TidalCycles meets Unity 3D.
* [tidal-maxmsp](https://github.com/datamads/tidal-maxmsp) ⚠️ Archived - Connecting the Tidal live coding environment to MaxMSP.
* [tidebox](https://github.com/DoubleDensity/tidebox) ⭐ 40 | 🐛 0 | 📅 2016-03-01 - TidalCycles live coding environment inside a Docker container.
* [CHmUsiCK](https://github.com/essteban/CHmUsiCK) ⭐ 39 | 🐛 6 | 🌐 ChucK | 📅 2023-09-27 - Library to make ChucK a 'more algorave like' language.
* [LÖVELive :two\_hearts:](https://github.com/sharow/lovelive) ⭐ 39 | 🐛 0 | 🌐 Lua | 📅 2018-10-04 - Live coding framework for LÖVE(2D Game Engine).
* [REPL Mode](https://github.com/joelmoniz/REPLmode) ⭐ 35 | 🐛 5 | 🌐 Java | 📅 2015-09-24 - This mode adds in a Read-Evaluate-Print-Loop console to Processing 3.0.
* [INSTRUMENT](https://github.com/punksnotdev/INSTRUMENT) ⭐ 31 | 🐛 1 | 🌐 SuperCollider | 📅 2026-05-13 - For live coding music and interfacing musical instruments and controllers in SuperCollider.
* [s2hs2](https://github.com/yecto/s2hs2-TidalCycles-0.8-) ⭐ 31 | 🐛 0 | 📅 2016-06-11 - An interface between TidalCycles and Processing.
* [tida1vm](https://github.com/lvm/tida1vm) ⭐ 31 | 🐛 0 | 🌐 Python | 📅 2020-06-30 - Another TidalCycles environment inside Docker.
* [p5-live](https://github.com/yangsu/p5-live) ⭐ 23 | 🐛 0 | 🌐 JavaScript | 📅 2016-05-04 - Live Coding for p5.js.
* [tidal-chord](https://github.com/fp4me/tidal-chord) ⭐ 23 | 🐛 0 | 🌐 Haskell | 📅 2016-06-24 - An add-on to the amazing live coding project TidalCycles.
* [Cowbells](https://github.com/omkamra/cowbells) ⭐ 17 | 🐛 0 | 🌐 Clojure | 📅 2023-12-20 - A Clojure library for musical experimentation and live coding.
* [TidalFX](https://github.com/calumgunn/TidalFX) ⭐ 17 | 🐛 1 | 🌐 SuperCollider | 📅 2018-12-08 - A haskell package adding weirder effects to Tidal from non-standard UGens.
...
* [textmode.synth.js](https://github.com/humanbydefinition/textmode.synth.js) ⭐ 9 | 🐛 2 | 🌐 TypeScript | 📅 2026-08-25 - A hydra-inspired visual synthesis plugin for textmode.js that drives procedural ASCII/textmode animations through a chainable, WebGL-powered API.
...
* [howto\_co34pt\_liveCode](https://theseanco.github.io/howto_co34pt_liveCode/) - Guide on how to live code in SuperCollider based on the performance practice of live coder coï¿¥ï¾¡pt.
...
* [Algorave Guidelines](https://github.com/Algorave/guidelines) ⭐ 156 | 🐛 1 | 📅 2025-08-24 - Guidelines to host an Algorave.
...
* [Awesome Creative Coding](https://github.com/terkelg/awesome-creative-coding) ⭐ 15,241 | 🐛 7 | 🌐 HTML | 📅 2026-07-21 - Creative Coding, Generative Art, Interaction Design, Resources.
* [Awesome Audio visualization](https://github.com/willianjusten/awesome-audio-visualization) ⭐ 5,064 | 🐛 13 | 🌐 Shell | 📅 2026-08-13 - A curated list about Audio Visualization.
...
* [Awesome Music](https://github.com/ciconia/awesome-music) ⭐ 2,482 | 🐛 26 | 📅 2026-05-27 - A categorized collection of awesome music libraries, tools, frameworks and software.
...
* [Awesome TidalCycles](https://github.com/tidalcycles/awesome-tidalcycles) ⭐ 126 | 🐛 0 | 📅 2024-06-02 - An awesome list about the pattern-based live coding system TidalCycles (or just 'Tidal' for short) and its close relatives
...
This has been brought to you by [these](https://github.com/lvm/awesome-livecoding/issues) ⭐ 3,276 | 🐛 7 | 📅 2026-08-10 [contributors](https://github.com/lvm/awesome-livecoding/graphs/contributors) ⭐ 3,276 | 🐛 7 | 📅 2026-08-10.
